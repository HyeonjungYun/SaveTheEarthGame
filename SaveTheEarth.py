...
def show_stage_and_time():
    ...
    time_left = max(0, 60 - (pygame.time.get_ticks() - stage_start_time) // 1000)
    time_text = font.render("Next Stage In: " + str(time_left) + "s", True, (255, 255, 255))
